...
DATABASES['default']['NAME'] = 'ansible0_%s' % ENVIRONMENT.lower()
DATABASES['default']['USER'] = 'ansible0_%s' % ENVIRONMENT.lower()
DATABASES['default']['HOST'] = os.environ.get('DB_HOST', '')
DATABASES['default']['PORT'] = os.environ.get('DB_PORT', '')
DATABASES['default']['PASSWORD'] = os.environ.get('DB_PASSWORD', '')

WEBSERVER_ROOT = '/var/www/ansible0/'
...
EMAIL_SUBJECT_PREFIX = '[Ansible0 %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://ansible0_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/ansible0_%(ENVIRONMENT)s' % os.environ  # noqa
